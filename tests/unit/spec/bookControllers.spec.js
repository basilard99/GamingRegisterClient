...
describe('Book Controllers -', function bookControllersTestSuite() {
    ...
    beforeEach(function setUpForEachTest() {
        ...
        module(function createMockPublisherListService($provide) {
            $provide.service('publisherListService', function() {
                this.getPublisherList = jasmine.createSpy('getPublisherList');
            });
        });
        
        inject(function setUpMocks(_$controller_, _$httpBackend_, _$http_, _$q_, _$rootScope_, _locationService_, _publisherListService_) {
    ...
    function defineSuccessfulRemoteGet() {
        publisherListService.getPublisherList.and.callFake(function(uri) {
        ...
        addBookController = $controller('addBookController', { '$http': $http, 'locationService': locationService, 'publisherListService': publisherListService });
    }
